...
const Rules: React.FC<Props> = ({ onStart, disabled }) => {
  return (
    <div className="sm:p-2 flex flex-col items-center max-w-3xl mx-auto">
      <h1 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-black text-center tracking-wide leading-snug mb-4">
        Co to za
      ...
      <div className="flex flex-col items-center space-y-8">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-12 sm:w-auto">
          <button
            className={`sm:px-6 sm:py-3 px-4 py-2 sm:w-auto rounded-full outline-none relative overflow-hidden border duration-300 ease-linear
                ...
                bg-primary border-transparent hover:border-[#172554] after:bg-[#172554] text-white flex justify-center w-full ${disabled ? "bg-gray-400 cursor-not-allowed" : "bg-primary border-transparent"}`}
            onClick={onStart}
            disabled={disabled}
          >
          ...
          <button
            className="sm:px-6 sm:py-3 px-4 py-2 sm:w-auto rounded-full outline-none relative overflow-hidden border duration-300 ease-linear
                after:absolute after:inset-x-0 after:aspect-square after:scale-0 after:opacity-70 after:origin-center after:duration-300 after:ease-linear after:rounded-full after:top-0 after:left-0
                hover:after:opacity-100 hover:after:scale-[2.5]
                bg-primary border-transparent hover:border-[#172554] after:bg-[#172554] text-white flex justify-center w-full"
          >
            <span
